---
title: Création d’un package pour DSP
description: Découvrez comment créer un package pour regrouper et gérer les emplacements dans votre campagne DSP à des fins de création de rapports et d'optimisation.
